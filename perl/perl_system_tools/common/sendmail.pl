...
#		message:	#mail body
#
# Update Log: 2008-11-04 Jacky
#			  modify main code, delete standmail,use HTML as default
#			  
#		
# 
#**********************************************************
...
my ($par_count,@par_final,$mailserver,$user,$pass,$mailto,@mailto,$mailtocc,@mailtocc,$mailfrom,$subject,$attachment,@attachment,$text,$attach_test,$mylogopen,$type);
...
\tmessage:\t\t#mail body\n
Example: 
$scriptbasename server:mail.livebytouch.com user:test\@livebytouch.com pass:111111 to:user1\@sina.com,user2\@sina.com cc:admin\@163.com,admin2\@163.com from:test sub:\"Test mail from perl sendmail\" attach:/home/test/123.txt type:html message:\"mailbody\"\n";
exit 3;
}
...
$mimebody->attach(Type => 'HTML',Data => $text);
